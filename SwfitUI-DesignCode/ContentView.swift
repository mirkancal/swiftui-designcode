...
//  SwfitUI-DesignCode
//
//  Created by Mirkan Çalışkan on 16.11.2021.
//
...
struct ContentView: View {
    ...
    var body: some View {
        ZStack {
            ...
            Text("\(showFull ? "T" : "F")").offset(y: -380)
    ...
    var body: some View {
        VStack(spacing: 20) {
            Rectangle()
                ...
                .cornerRadius(3)
                .opacity(0.1)
            Text("Number in a series of vaccinations/doses and the overall number of doses in the series: 1/2")
